CREATE TABLE time_zone (
                           id             NUMBER(2) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
...
CREATE TABLE country (
                         id           NUMBER(3)    GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
                         name         VARCHAR2(128),
...
CREATE TABLE payment_status (
                                payment_status_id NUMBER       GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
...
CREATE TABLE seat_type (
                           id   NUMBER(1)    GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
...
CREATE TABLE extra_services (
                                id    NUMBER(4)    GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
                                name  VARCHAR2(128) NOT NULL,
...
CREATE TABLE route_statistics (
                                  routes_id        NUMBER(4) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
